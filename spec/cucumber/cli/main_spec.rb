  ...
  module Cli
    describe Main do
      ...
      describe "verbose mode" do
        ...
        it "should show feature files parsed" do
          ...
          @cli.execute!(StepMother.new, FeatureSuite.new)
      ...
      describe "diffing" do
        ...
        before :each do
          ...
          @feature_suite = mock('FeatureSuite', :null_object => true)
    ...
    [ProfilesNotDefinedError, YmlLoadError, ProfileNotFound].each do |exception_klass|
      ...
      it "rescues #{exception_klass}, prints the message to the error stream and returns true" do
        ...
        main.execute!(StepMother.new, FeatureSuite.new).should be_true
      ...
      context "--drb" do
        ...
        it "returns the result from the DRbClient" do
          ...
          @cli.execute!(@step_mother, @feature_suite).should == 'foo'
        end
